...
This routine works on both the disk and sphere geometry.
For each of these geometry the routine are stored in a separate folder.

===== SOURCE CODE
    PotentialPins.jl (or PotentialPins_Sphere.jl for the sphere geometry)
    Potentials.jl

Also requires FQH_states_v2.jl, Misc.jl, and Density.jl from _qhe-library

Other accompanying routine (found in disk_potential_pins)
...
***NOTE: for the sphere geometry you will be prompted to input the θ and ϕ angles instead.
